...
const CONTACT_NOTE =
  'Номер квартиры и контакты для связи с конкретными участниками предоставляются по запросу ' +
  'администратору платформы и только с согласия соответствующего участника.'
