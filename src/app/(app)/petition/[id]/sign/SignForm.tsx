    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: '360px' }}>
          ...
          <h2 style={{ fontFamily: 'Unbounded, sans-serif', fontSize: '22px', fontWeight: 700, color: 'var(--forest)', letterSpacing: '-0.02em', marginBottom: '10px' }}>
            Подпись поставлена
          </h2>
          <p style={{ fontFamily: 'Golos Text, sans-serif', fontSize: '14px', color: 'var(--ink-soft)', lineHeight: 1.6 }}>
    ...
    <div style={{ minHeight: '100%', background: 'var(--cream)', overflowY: 'auto' }}>
      <div style={{
        ...
        <Link href={`/petition/${id}`} style={{
          color: 'var(--ink-soft)', fontSize: '13px',
          textDecoration: 'none', fontFamily: 'Golos Text, sans-serif',
      ...
      <div style={{ maxWidth: '520px', margin: '0 auto', padding: '48px 24px 80px' }}>
        <div style={{ marginBottom: '32px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: 'Unbounded, sans-serif', fontSize: '22px', fontWeight: 700, color: 'var(--ink)', letterSpacing: '-0.02em', margin: '0 0 8px' }}>
            Подписание заявления
          </h1>
          <p style={{ fontFamily: 'Golos Text, sans-serif', fontSize: '14px', color: 'var(--ink-soft)', margin: 0, lineHeight: 1.6 }}>
        ...
        {error && (
          <div style={{
            ...
            color: '#991B1B', fontSize: '14px', fontFamily: 'Golos Text, sans-serif',
          }}>
            {error}
          </div>
        )}
